            ...
            <Table striped>
                ...
                <tbody>
                    ...
                    <tr><td className="wd-full-name text-nowrap">
                        ...
                        <td className="wd-total-activity">11:15:48</td></tr>
                    ...
                    <tr><td className="wd-full-name text-nowrap">
                        ...
                        <td className="wd-role">STUDENT</td>
                        <td className="wd-last-activity">2020-10-01</td>
                        <td className="wd-total-activity">09:33:17</td></tr>
                    ...
                    <tr><td className="wd-full-name text-nowrap">
                        ...
                        <td className="wd-total-activity">12:52:45</td></tr>
                    ...
                    <tr><td className="wd-full-name text-nowrap">
                        ...
                        <td className="wd-last-activity">2020-10-03</td>
                        <td className="wd-total-activity">15:30:12</td></tr>
                </tbody>
            </Table>
        </div>
    );
